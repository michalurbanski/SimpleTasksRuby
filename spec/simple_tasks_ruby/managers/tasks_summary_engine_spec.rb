...
describe SimpleTasksRuby::TasksSummaryEngine do
  describe "Positive cases" do
    it "Returns task count of delayed tasks" do
      ...
      tasks_hash[SimpleTasksRuby::TaskType::DELAYED] = tasks

      tasks_summary_engine = SimpleTasksRuby::TasksSummaryEngine.new(tasks_hash)
    ...
    it "Returns tasks count by status" do
      ...
      tasks_hash[SimpleTasksRuby::TaskType::DELAYED] = [first_task, second_task]
      tasks_hash[SimpleTasksRuby::TaskType::ABORTED] = [aborted_task]
